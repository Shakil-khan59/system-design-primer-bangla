...
* **Accounts API** server [Amazon SQS](https://aws.amazon.com/sqs/) বা [RabbitMQ](https://www.rabbitmq.com/) এর মতো একটি **Queue** এ একটি job রাখে
    * Transactions extract করা কিছু সময় নিতে পারে, আমরা সম্ভবত এটি [asynchronously with a queue](https://github.com/Shakil-khan59/system-design-primer-bangla#asynchronism) করতে চাই, যদিও এটি additional complexity প্রবর্তন করে
...
আমরা `id`, `user_id `, এবং `created_at` এ একটি [index](https://github.com/Shakil-khan59/system-design-primer-bangla#use-good-indices) তৈরি করব।
...
আমরা `id` এবং `user_id ` এ একটি [index](https://github.com/Shakil-khan59/system-design-primer-bangla#use-good-indices) তৈরি করব।
